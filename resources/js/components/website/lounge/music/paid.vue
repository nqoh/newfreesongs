 ...
 <div v-if="!show">
        <div class="row">
            ...
            <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12" style="padding-bottom: 27px" v-for="(track,i) in music.data">
                ...
                <p><a :href="'/' + track.download_code"><b @click="ChangedMusic(track.download_code)">{{ priceCurrency.currency }} {{ priceCurrency.price.toFixed(2) }} Buy</b></a> <b>{{track.downloads | formatNumber}}</b>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page) {
                ...
                $.get('/api/getLoungePaidMusic/'+this.id+'?page=' + page, (data) => {
                    this.music = data,
                    this.show= false,
