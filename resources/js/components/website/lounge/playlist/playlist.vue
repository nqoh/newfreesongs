...
<div v-if="!show">
        <div class="row">
            <div class="col-xl-6 col-md-6 col-lg-6" style="padding-bottom: 27px" v-for="(track,i) in music.data">
                ...
                <div class="icon_and_label">
                    <div class="by"></div>
                    <small><b>By :</b>
                        <span v-if=" username === track.username " to="/profile/feeds"><span style="font-weight: normal;font-style: normal" >{{ track.name | Ucfirst }}</span></span>
                ...
                <p v-if=" track.price == '0' "><a :href="'/'+track.download_code">
                    <b @click="ChangedMusic(track.download_code)">Download</b></a> <b>{{track.downloads | formatNumber}}</b>
                    downloads <a :href="'lyrics/' + track.download_code"><b class="link">Lyrics</b></a>
                </p>

                <p v-if=" track.price == '1' "><a :href="'/'+track.download_code">
                    <b @click="ChangedMusic(track.download_code)">{{ priceCurrency.currency }}
                        {{ priceCurrency.price.toFixed(2) }} Buy</b></a> <b>{{track.downloads | formatNumber}}</b>
                    downloads<a :href="'lyrics/' + track.download_code"><b class="link">Lyrics</b></a>
                </p>
            </div>
        ...
        <p v-if=" music.data == '' " align="center" class="nothing">You have no new playlist.</p>
    </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page) {
                ...
                $.get('/getLoungePlaylist/'+this.id+'?page=' + page, (data) => {
