     ...
     <hr>
      <div v-if="showOffline">
        ...
        <div class="row container-fluid">
            <div class="alert col-xl-8 col-md-8 col-lg-8 ">
                <div class="top_label alert"><h5 align="center">Most Downloaded Tracks</h5></div>

                    <div class="row alert container-fluid mostDownload" @scroll="LoardMoreMusic(num)" id="tracks_container">


                        <div v-if="showMusic"  v-for="i in 10" style="padding-bottom: 20px;padding-left:12px" class="col-xl-6 col-md-6 col-lg-6">
                            <vue-content-loading secondary="#eed5b7" primary="#d19275" :width="200" :height="70">
                        ...
                        <div v-if="!showMusic" v-for="(track,i) in music" style="margin-bottom: 20px" class="col-xl-6 col-md-6 col-lg-6">
                            <b class="music_num">{{ i + 1 }}. </b>
                            <a :href="'/' + track.download_code "><img :src="track.album_art" :alt="track.track" onerror="this.src='/thumbnails/olova.png';"></a>
                            ...
                            <div class="icon_and_label">
                                <div class="by"></div>
                                <small><b>By :</b>
                                    <a :href="'/' + track.username ">{{ track.name }}
                                    </a>
                                </small>
                            </div>
        ...
        padding: 9px 0px 0px 13px;">
                    ...
                    <div  class="animated   slower track" style="padding-bottom: 35px;">
                        ...
                        <p style="margin: 0px" v-if=" ads.musics[0].price == '1' ">
                            ...
                            <a :herf="'/lyrics/' + ads.musics[0].download_code"><b>Lyrics</b></a>
                        </p>
                    </div>
                    ...
                    <div  class="animated  slower lounge" style="padding-bottom: 35px; width: 92%">
                        ...
                        <div style="padding-left: 10px; margin-top:-10px">
                            <strong><a :herf="'/' + ads.lounge.username"  style=";font-size: 18px; color: rgb(149,75,75)">{{ads.lounge.name |
                                Ucfirst}}</a></strong>
                    ...
                    <div class="animated   slower track" style="padding-bottom: 35px;">
                        <a :herf="'/' + ads.musics[1].download_code"><img :src="ads.musics[1].album_art" :alt="ads.musics[1].track" onerror="this.src='/thumbnails/olova.png';"></a>
                        <div class="icon_and_label">
                            <div class="icon"></div>
                        ...
                        <div class="icon_and_label">
                            <div class="by"></div>
                            <small><b>By :</b>
                                <a :herf="'/'+ ads.musics[1].username">{{ ads.musics[1].name | Ucfirst }}
                                </a>
                            </small>
                        </div>


                        <p style="margin: 0px" v-if=" ads.musics[1].price == '0' "><a :herf="'/' + ads.musics[1].download_code "><b>Download</b></a>
                            <b>{{ ads.musics[1].downloads | formatNumber }}</b> downloads
                            <a :herf="'/lyrics/' + ads.musics[1].download_code"><b>Lyrics</b></a>
                        </p>

                        <p style="margin: 0px" v-if=" ads.musics[1].price == '1' ">
                            <a :herf="'/' + ads.musics[1].download_code"><b>{{ priceCurrency.currency }}
                                {{ priceCurrency.price.toFixed(2) }} Buy</b></a>
                            <b>{{ ads.musics[0].downloads | formatNumber }}</b> Purchases
        ...
        <hr>
        <a href="/"><h3 align="center"><a>Trending Tracks</a></h3></a>
        <hr>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            LoardMoreMusic(num) {
                var element = document.getElementById('tracks_container');
