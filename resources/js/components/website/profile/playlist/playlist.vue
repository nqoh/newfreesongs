            ...
            <div class="col-xl-6 col-md-6 col-lg-6" style="padding-bottom: 27px" v-for="(track,i) in music.data">
                ...
                <div class="icon_and_label">
                    ...
                    <small><b>By :</b>
                        ...
                        <a v-else :href="'/' +track.username ">{{ track.name | Ucfirst }}</a>
                    </small>
                </div>
                <p v-if=" track.price == '0' "><a :href="'/' + track.download_code "><b>Download</b></a> <b>{{track.downloads | formatNumber }}</b>
                    downloads <span @click="RemoveOnPlaylist(track.id)" ><b>Remove</b></span>
                </p>

                <p v-if=" track.price == '1' "><a :href="'/' + track.download_code"><b>{{ priceCurrency.currency }} {{ priceCurrency.price.toFixed(2) }} Buy</b></a> <b>{{track.downloads | formatNumber}}</b>
                    downloads <span @click="RemoveOnPlaylist(track.id)" ><b>Remove</b></span>
                </p>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page) {
                ...
                $.get('/getPlaylist?page=' + page, (data) => {
                    buss.$emit('Closeloading','')
                    this.music = data
                    this.show = false
                })
