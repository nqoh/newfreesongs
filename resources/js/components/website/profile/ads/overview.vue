<template>
    <div>
        <p v-if=" member.data != '' " style="font-size: 20px" align="center" class="nothing">This are live promos</p>
        <div class="row" style="padding: 0px">
            <div v-for="user in member.data" class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12" style="padding-top: 10px;;padding-bottom: 20px;">
                ...
                <div v-if=" user.music_id != '0' ">
                    ...
                    <p>
                        <router-link :to="'/profile/ads/insights/' + user.id "><b>View Insight</b></router-link>
                    </p>
        ...
        <p v-if=" member.data == '' " align="center" class="nothing">You have no new promo.</p>
    ...
    export default {
        ...
        methods: {
            getResults(page) {
                ...
                $.get('/api/getAdsOverview?page=' + page, (response) => {
