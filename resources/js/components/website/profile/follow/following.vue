<template>
    <div>
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-3 col-3" v-for="(following,i) in followings.data">
                <a :href=" '/' + following.username "><img :src="following.image" class="card-img" onerror="this.src='/thumbnails/newuser.gif';"></a>
                <p align="center" style="margin: 0px">
                    <a :href=" '/' + following.username "><b>{{ following.name.substr(0,8) | Ucfirst}}</b></a>
                </p>
                <p style="margin: 0px 0px 5px 0px" align="center">
        ...
        <div style="clear: both; margin-top: -10px">
            ...
            <button v-if="followings.current_page > 1" @click="getResults(followings.current_page - 1)" class="prev"> <
            </button>
            <h2 v-if="followings.current_page != followings.last_page">{{ followings.current_page }} </h2>
            <button v-if="followings.current_page != followings.last_page" @click="getResults(followings.current_page + 1)"
                    class="next"> >
            </button>

        </div>
        <p v-if=" followings.data == '' " align="center" class="nothing">You do not have any following.</p>
    </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            getResults(page) {
                ...
                $.get('/api/ProfileFollowings?page=' + page, (response) => {
