            ...
            <div class="row" >
                <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12" style="padding-bottom: 27px" v-for="(track,i) in music.data">
                    <a :href="'/' + track.download_code ">
                        <img @click="ChangedMusic(track.download_code)" :src="track.album_art" onerror="this.src='/thumbnails/olova.png';">
                    </a>
                    ...
                    <p><a :href="'/' + track.download_code "><b @click="ChangedMusic(track.download_code)">Download</b></a> <b>{{track.downloads | formatNumber}}</b>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page) {
                ...
                $.get('/api/getLoungeFreeMusic/'+this.id+'?page=' + page, (data) => {
                    this.music = data
