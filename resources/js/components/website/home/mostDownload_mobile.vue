<template>
    <div>
        ...
        <hr>
        <div class="alert trending_div"><h5 align="center">Most Downloaded Tracks</h5></div>
        <hr>
   ...
   <div v-if="!musicShow" class="mostDownload" @scroll="LoardMoreMusics(num)" id="mostDownloads">
...
<script>
    ...
    export default {
        ...
        methods: {
            LoardMoreMusics(num) {
                var element = document.getElementById('mostDownloads');
