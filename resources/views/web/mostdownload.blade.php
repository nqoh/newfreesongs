...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <meta property='og:image' content='https://bogiyo.com/thumbnails/olova_logo.png' />
    ...
    <link rel="canonical" href="https://bogiyo.com/mostdownloads">
    ...
    <title>Bogiyo | MostDownloads</title>
...
<script>
 window.addEventListener('load', function() {
       try{
           ...
           window.location='https://m.bogiyo.com/mostdownloads'
       }
    }
    );
...
<div id="app">
    ...
    <app-mostdownloads></app-mostdownloads>
    <span id="login"></span>
