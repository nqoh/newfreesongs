<template>
    <div style="margin:0px">
        ...
        <span style="float:right; margin-right: 5%;  font-size:13px"><b>Total Sales :
           {{ priceCurrency.currency }} {{ ((totalDownloads * priceCurrency.price) / 100 * 75).toFixed(2) }}</b></span><br style="line-height:.1">
        <div class="row">

            <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12" style="padding-bottom: 20px" v-for="(track,i) in music.data">
                <a :href="'/' + track.download_code "><img :src="track.album_art"></a>
                ...
                <p>
                    ...
                    </a>&nbsp;&nbsp;<b>{{track.downloads}}</b>
                    Purchases  &nbsp;&nbsp;{{ priceCurrency.currency }} {{ ((track.downloads * priceCurrency.price) / 100 * 75).toFixed(2) }}
                </p>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getTotalPrice(){
               $.get('/api/getTotalPaid',(downloads)=>{
