...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <meta name="msvalidate.01" content="7EBD43D478FBFCE29F1F747CC42C6F61" />
    ...
    <meta name='Description' content='Read  {{$music->track}} lyrics and download
    ...
    <link rel="canonical" href='https://bogiyo.com/lyrics/{{$music->download_code}}'>

    <meta property='og:image' content="http://bogiyo.com/album_art/
    {{ substr($music->track,0,strlen($music->track) - 3) }} 'jpg'" />

    <meta property='og:title' content='Read  {{$music->track }} lyrics' />

    <meta property='og:type' content='image/jpg' />

    <meta property='og:url' content='https://bogiyo.com/lyrics/{{$music->download_code}}' />
    ...
    <meta name='twitter:title' content='Read  {{$music->track }} lyrics' />

    <meta name='twitter:description' content='Read  {{$music->track}} lyrics and download
    the track for free - Music From All Over' />
    ...
    <title>Bogiyo | Lyrics for {{$music->track}}</title>
...
<script>
 window.addEventListener('load', function() {
       try{
           ...
           window.location='https://m.bogiyo.com/lyrics/<?php echo $id; ?>'
       }
    }
    );
