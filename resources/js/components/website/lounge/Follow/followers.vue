       ...
       <div v-if="!showLoader" >
        <div class="row" style="padding: 5px">
            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-3 col-3" v-for="(followers,i) in followers.followers.data">
                ...
                <a :href=" '/' + followers.username " v-if=" username != followers.username ">
                    <img :src="followers.image" onerror="this.src='/thumbnails/newuser.gif';" @click="getLounge(followers.username)" class="card-img"></a>
                <a href="/profile/feeds" v-else><img :src="followers.image" onerror="this.src='/thumbnails/newuser.gif';" class="card-img"></a>

                <p align="center" v-if=" username != followers.username "><a :href=" '/' + followers.username ">
                    <b @click="getLounge(followers.username)">{{ followers.name.substr(0,8) | Ucfirst}}</b></a></p>
                <p align="center" style="margin: 0px;padding: 0px" v-else><a href="/profile/feeds"><b>{{ followers.name.substr(0,8) | Ucfirst}}</b></a></p>

                <span v-if="username">
                   <span v-if="username == followers.username">
                   </span>

                   <span v-else>
                <p align="center" style="margin: -16px 0px 5px 0px" v-if=" getFollowingId(followers.id) ">
        ...
        <p v-if=" followers.followers.data == '' " align="center" class="nothing">No new followers.</p>
    </div>
    </div>
</template>
    ...
    export default {
        ...
        methods:{
            ...
            getResults(page) {
                ...
                this.followings_id=[]
                $.get('/api/LoungeFollowers/'+this.id+'?page=' + page, (response) => {
