<template>
    <div style="margin:10px">
        ...
        <div class="row" >
            <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12" style="padding-bottom: 27px" v-for="(track,i) in music.data">
                <a :href="'/' + track.download_code ">
                    <img :src="track.album_art" @click="ChangedMusic(track.download_code)" onerror="this.src='/thumbnails/olova.png';">
                </a>
                ...
                <div class="icon_and_label">
                    <div class="by"></div>
                    <small><b>By :</b>
                        <a :href="'/' +track.username ">{{ track.name | Ucfirst }}</a>
                    </small>
                </div>

                <p v-if=" track.price == '0' " ><a :href="'/' + track.download_code "><b @click="ChangedMusic(track.download_code)">Download</b></a> <b>{{track.downloads | formatNumber}}</b>
                    downloads <a :href="'/lyrics/' + track.download_code" ><b>Lyrics</b></a>
                </p>

                <p v-if=" track.price == '1' "><a :href="'/' + track.download_code"><b @click="ChangedMusic(track.download_code)">{{ priceCurrency.currency }} {{ priceCurrency.price.toFixed(2) }} Buy</b></a> <b>{{track.downloads | formatNumber}}</b>
                    downloads <a :href="'/lyrics' + track.download_code" ><b>Lyrics</b></a>
                </p>
        ...
        <p v-if=" music.data == '' " align="center" class="nothing">You have no new free music.</p>
    </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page) {
                ...
                $.get('/api/getLoungeAllMusic/'+this.id+'?page=' + page, (data) => {
